...
public abstract class AbstractI18nExceptionMessageProcessor<T extends Exception> extends AbstractTypeExceptionMessageProcessor<T> {
     ...
     * @return I18N信息
     */
    protected String i18nMessage(String code, String defaultMessage, String ...args) {
        if (I18nUtils.supportI18n() && StringUtils.isBlank(code)) {
            return I18nUtils.get(code);
        }
     ...
     * @return I18N信息
     */
    protected String i18nMessage(I18nMessage message, String defaultMessage, String ...args) {
